...
If planContext.authoritativeTankState is provided, treat it as the highest-priority source of truth. It overrides the fixed tank profile, old chat history, old generated plans, templates, and default inventory. Do not create tasks for livestock with activeInTank=false, allowPlanningTasks=false, status historical/lost/resolved/rehomed, or issues/protocols marked resolved/completed. In particular: do not include KFC/cipro/amoxicillin recovery tasks if kfcRecovery is completed; do not include chaeto/refugium tasks if chaetoReactorCancelled is true; do not include Australian Stripy tasks if rehomed; do not include hammer/torch observation or care if hammersTorchesLost is resolved.
