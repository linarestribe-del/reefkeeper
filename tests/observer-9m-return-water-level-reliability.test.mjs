...
assert.match(publisher, /PUBLISHER_VERSION = '2\.8\.4'/, 'Publisher version should be 2.8.4.');
...
assert.match(index, /Reef Keeper v4\.3\.70 Maintenance 9N/, 'App settings version should show 9N.');
assert.match(index, /Water-level learning is available; return timelapse support is active\./, 'Return chamber tools should describe water-level learning.');
