...
assert.equal(pkg.version, '4.3.61');
assert.match(html, /Reef Keeper v4\.3\.61 Maintenance 9I.1/);
...
assert.match(filterEngine, /const VERSION = '9I.1'/);
...
console.log('Maintenance 9I.1 observer scoping and filter-roll action tests passed.');
