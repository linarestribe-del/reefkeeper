...
assert.equal(pkg.version, '4.3.60');
assert.match(html, /Reef Keeper v4\.3\.60 Maintenance 9I/);
...
assert.match(filterEngine, /const VERSION = '9I'/);
...
console.log('Maintenance 9I observer scoping and filter-roll action tests passed.');
