...
assert.ok(html.includes('/filter-roll-engine.js?v=4.3.63'));
assert.ok(html.includes('/filter-roll-status.js?v=4.3.63'));
assert.ok(html.includes('/filter-roll-status.css?v=4.3.63'));
assert.ok(html.lastIndexOf('/filter-roll-status.js?v=4.3.63') < html.lastIndexOf('</body>'), '9D script must be linked from the real application body.');
