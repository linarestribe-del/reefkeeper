...
assert(html.includes('css/app.css?v=20260720-build-2g-multi-image-comparison'));
...
assert(html.includes('app.js?v=20260720-build-2g-multi-image-comparison'));
assert(html.includes('observer.js?v=20260720-build-2g-multi-image-comparison'));
...
assert.equal(pkg.version, '4.3.25');
