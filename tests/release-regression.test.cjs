...
assert(html.includes('css/app.css?v=20260721-build-2i-observer-health'));
...
assert(html.includes('app.js?v=20260721-build-2i-observer-health'));
assert(html.includes('observer.js?v=20260721-build-2i-observer-health'));
...
assert.equal(pkg.version, '4.3.27');
