...
assert(html.includes('Reef Keeper v4.3.70 Maintenance 9N'));
...
assert(fs.existsSync('connector/install-return-water-level-learning-1.0.sh'));
...
assert(fs.readFileSync('connector/observer-publisher.py', 'utf8').includes("PUBLISHER_VERSION = '2.8.4'"));
