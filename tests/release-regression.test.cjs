...
assert(html.includes('css/app.css?v=20260721-build-2l1-hobby-plan-fix'));
...
assert(html.includes('app.js?v=20260721-build-2l1-hobby-plan-fix'));
...
assert.equal(pkg.version, '4.3.31');
