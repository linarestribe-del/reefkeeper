...
assert(html.includes('css/app.css?v=20260721-build-2h-observer-history'));
...
assert(html.includes('app.js?v=20260721-build-2h-observer-history'));
assert(html.includes('observer.js?v=20260721-build-2h-observer-history'));
...
assert.equal(pkg.version, '4.3.26');
