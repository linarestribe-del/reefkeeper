...
assert(html.includes('css/app.css?v=20260720-build-2f4-clean-overlay-fix'));
...
assert(html.includes('app.js?v=20260720-build-2f5-vision-timeout-fix'));
assert(html.includes('observer.js?v=20260720-build-2f4-clean-overlay-fix'));
...
assert.equal(pkg.version, '4.3.22');
