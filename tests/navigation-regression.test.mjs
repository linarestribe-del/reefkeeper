...
assert.ok(html.indexOf('ai/evidence-engine.js?v=20260717-build-1b') < html.indexOf('app.js?v=20260720-build-2f5-vision-timeout-fix'), 'Evidence engine must load before app.js');
...
assert.ok(html.indexOf('ai/trend-chart.js?v=20260718-build-2b') < html.indexOf('app.js?v=20260720-build-2f5-vision-timeout-fix'), 'Trend chart module must load before app.js');
assert.ok(html.indexOf('observer.js?v=20260720-build-2f4-clean-overlay-fix') > html.indexOf('app.js?v=20260720-build-2f5-vision-timeout-fix'), 'Observer controller must load after app.js');
