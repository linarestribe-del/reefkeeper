...
assert.ok(html.indexOf('ai/evidence-engine.js?v=20260717-build-1b') < html.indexOf('app.js?v=20260722-maintenance-7b-status-canvas'), 'Evidence engine must load before app.js');
...
assert.ok(html.indexOf('ai/trend-chart.js?v=20260718-build-2b') < html.indexOf('app.js?v=20260722-maintenance-7b-status-canvas'), 'Trend chart module must load before app.js');
assert.ok(html.indexOf('observer.js?v=20260721-build-2l1-hobby-plan-fix') > html.indexOf('app.js?v=20260722-maintenance-7b-status-canvas'), 'Observer controller must load after app.js');
