...
assert.ok(html.indexOf('ai/evidence-engine.js?v=20260717-build-1b') < html.indexOf('app.js?v=20260724-maintenance-9c-outer-edge'), 'Evidence engine must load before app.js');
...
assert.ok(html.indexOf('ai/trend-chart.js?v=20260718-build-2b') < html.indexOf('app.js?v=20260724-maintenance-9c-outer-edge'), 'Trend chart module must load before app.js');
assert.ok(html.indexOf('observer.js?v=20260724-maintenance-9c-outer-edge') > html.indexOf('app.js?v=20260724-maintenance-9c-outer-edge'), 'Observer controller must load after app.js');
assert.ok(html.indexOf('integration-core.js?v=20260724-maintenance-9c-outer-edge') > html.indexOf('app.js?v=20260724-maintenance-9c-outer-edge'), 'Integration Core must load after app.js');
assert.ok(html.indexOf('integration-core.js?v=20260724-maintenance-9c-outer-edge') < html.indexOf('observer.js?v=20260724-maintenance-9c-outer-edge'), 'Integration Core must load before Observer controller');
