...
assert.ok(html.indexOf('ai/evidence-engine.js?v=20260717-build-1b') < html.indexOf('app.js?v=20260718-build-2a-analytics'), 'Evidence engine must load before app.js');
assert.ok(html.indexOf('ai/trend-engine.js?v=20260718-build-2a') < html.indexOf('app.js?v=20260718-build-2a-analytics'), 'Trend engine must load before app.js');
