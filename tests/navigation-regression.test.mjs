...
assert.ok(html.indexOf('ai/evidence-engine.js?v=20260717-build-1b') < html.indexOf('app.js?v=20260722-maintenance-8a-r2-storage'), 'Evidence engine must load before app.js');
...
assert.ok(html.indexOf('ai/trend-chart.js?v=20260718-build-2b') < html.indexOf('app.js?v=20260722-maintenance-8a-r2-storage'), 'Trend chart module must load before app.js');
assert.ok(html.indexOf('observer.js?v=20260722-maintenance-8a-r2-storage') > html.indexOf('app.js?v=20260722-maintenance-8a-r2-storage'), 'Observer controller must load after app.js');
