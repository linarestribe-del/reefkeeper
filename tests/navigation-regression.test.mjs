...
assert.ok(html.indexOf('observer.js?v=20260720-build-2f6-sump-analysis') > html.indexOf('app.js?v=20260720-build-2f5-vision-timeout-fix'), 'Observer controller must load after app.js');
