...
const installer = fs.readFileSync(path.join(root, 'connector', 'install-observer-publisher-2.7.sh'), 'utf8');
...
assert.match(publisher, /PUBLISHER_VERSION = '2\.7'/);
...
assert.match(installer, /PUBLISHER 2\.7 ACTIVE/);
