...
assert.ok(html.includes('Reef Keeper v4.3.73 Maintenance 9O'));
...
for (const requiredTest of [
  ...
  'observer-9o-filter-roll-diagnostics-collapse.test.mjs',
...
console.log('Stable safeguards remain active in v4.3.73.');
