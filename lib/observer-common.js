// Reef Keeper Build 2L — Observer validation, health, history, daily summaries, change alerts, and timelapses

import { timingSafeEqual } from 'node:crypto';

export const OBSERVER_SCHEMA_VERSION = 6;
...
export const OBSERVER_TIMELAPSE_METADATA_ROUTE = '/api/observer-timelapses';
export const OBSERVER_TIMELAPSE_VIDEO_ROUTE = '/api/observer-timelapse';
...
export function normalizeObserverChangeAlert(value, index = 0) {
  ...
  const title = cleanObserverString(item.title || 'Observer change needs review', 140);
