// Reef Keeper v4.3.3 Live Probes Stack Fix
...
(function(){
  ...
  function injectStyles(){
    ...
    style.textContent = `
      ...
      .rk-live-wrap{display:block;width:100%;max-width:100%;overflow:hidden;box-sizing:border-box;}
      .rk-live-top{display:grid;grid-template-columns:minmax(0,1fr);gap:12px;width:100%;max-width:100%;box-sizing:border-box;overflow:hidden;}
      ...
      @media(min-width:920px){.rk-live-top{grid-template-columns:1fr;align-items:stretch}.rk-probe-grid{grid-template-columns:repeat(4,minmax(0,1fr))}.rk-equipment-live{grid-template-columns:repeat(2,minmax(0,1fr));}}
      @media(max-width:520px){.rk-live-top{display:block}.rk-live-top>div+div{margin-top:14px}.rk-probe-grid{grid-template-columns:repeat(2,minmax(0,1fr));gap:9px}.rk-live-health{padding:12px}.rk-live-health-title{font-size:.98rem}.rk-live-health-score{font-size:1.35rem}.rk-probe{padding:11px 10px}.rk-probe span{font-size:.78rem}.rk-probe strong{font-size:1.26rem}.rk-probe em{font-size:.74rem}.rk-eq-group{padding:9px}.rk-eq-state{font-size:.72rem}}@media(max-width:430px){.rk-probe-grid{grid-template-columns:1fr}.rk-probe strong{font-size:1.32rem}}
    `;
