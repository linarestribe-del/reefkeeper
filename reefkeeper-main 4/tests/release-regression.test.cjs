...
assert(html.includes('css/app.css?v=20260720-build-2f3-observer-overlay-fix'));
...
assert(html.includes('observer.js?v=20260720-build-2f3-observer-overlay-fix'));
...
assert.equal(pkg.version, '4.3.20');
