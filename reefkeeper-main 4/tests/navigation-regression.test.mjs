...
assert.ok(html.indexOf('observer.js?v=20260720-build-2f3-observer-overlay-fix') > html.indexOf('app.js?v=20260718-build-2d-image-input'), 'Observer controller must load after app.js');
