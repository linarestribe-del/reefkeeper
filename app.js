...
// Some mobile Safari / PWA launches can evaluate inline handlers before all
// function names are visible as window properties. Keep critical functions
// explicitly attached to window so Days-Off AI planning and diagnostics can
// always find completed-history helpers.
(function reefKeeperExposeGlobals(){
  const names = [
    'getCompletedHistory',
    'setCompletedHistory',
    'getCompletedHistoryEntries',
    'setCompletedHistoryEntries',
    'getCurrentPlanPromptContext',
    'generateAiDaysOffPlan',
    'handleAiPlanButton',
    'renderCompletedHistory',
    'renderDaysOffWorkPlan',
    'renderReminderCenter'
